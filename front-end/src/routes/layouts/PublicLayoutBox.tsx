...
const PublicLayoutBox: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-gradient-to-b from-blue-50 via-blue-100 to-blue-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">          
          {children}
        </div>
      </main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                <div className="bg-gradient-to-r from-blue-600 to-blue-500 p-2 rounded-lg shadow-sm">
                  <svg 
                    className="h-5 w-5 text-white" 
                    xmlns="http://www.w3.org/2000/svg" 
                    viewBox="0 0 24 24" 
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li className="flex items-start">
                  <svg className="h-5 min-w-5 mr-2 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
